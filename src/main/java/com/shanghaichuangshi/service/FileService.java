...
public class FileService extends Service {
    ...
    public int count(String file_name, String request_user_id) {
        return fileDao.count(file_name, request_user_id);
    }

    public List<File> list(String file_name, String request_user_id, int m, int n) {
        return fileDao.list(file_name, request_user_id, m, n);
    }
